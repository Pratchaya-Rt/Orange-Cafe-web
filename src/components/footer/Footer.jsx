...
const Footer = () => {
  ...
  return (
    <>
        <footer className='text-white rounded-t-3xl bg-footer'>
            <div className='container mx-auto max-w-[1200px] p-4'>
                    ...
                    <div className='px-3 py-8'>
                        <h1 className='mb-3 text-justify text-xl font-bold sm:text-left sm:text-3xl'>
                            <a href="/#home" className=''>
                                Orange
                                <span className='inline-block font-bold text-secondary'>Cafe</span>
                            </a>
                        </h1>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis dolorum,
                            nulla a odit corrupti laudantium!
                        </p>
                        <br />
                ...
                <div className='bottom-footer'>
                    <p className='border-t-2 border-gray-300/50 py-6 text-center'>All rights reserve</p>
                </div>
            </div>
        </footer>
    </>
