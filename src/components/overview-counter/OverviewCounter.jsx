...
const OverviewCounter = () => {
  return (
    <section className='container h-12 md:h-32 p-3'>
        <div className='grid grid-cols-4 divide-x mx-auto w-full md:max-w-[800px] shadow-lg -translate-y-20 md:-translate-y-12 my-4 md:p-8 bg-white dark:bg-gray-800 dark:text-white/70'>
